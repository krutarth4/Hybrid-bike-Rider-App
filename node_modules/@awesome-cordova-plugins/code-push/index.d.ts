...
export declare type Callback<T> = (error: Error, parameter: T) => void;
 ...
 * ```
 */
export declare class CodePushOriginal extends AwesomeCordovaNativePlugin {
    /**
...
export declare const CodePush: CodePushOriginal;