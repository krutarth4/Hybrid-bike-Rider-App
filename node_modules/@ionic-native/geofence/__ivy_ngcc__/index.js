...
var Geofence = (function (_super) {
    ...
    Geofence.prototype.onTransitionReceived = /**
       ...
       */
        function () {
            console.debug("debug plugin tranistion");
            return;
        };
    /**
    ...
    function (geofences) { 
        ...
        console.debug("debug plugin addorUpdate", geofences);
...
Geofence.ɵfac = /*@__PURE__*/ function () { var ɵGeofence_BaseFactory; return function Geofence_Factory(t) { return (ɵGeofence_BaseFactory || (ɵGeofence_BaseFactory = ɵngcc0.ɵɵgetInheritedFactory(Geofence)))(t || Geofence); }; }();
Geofence.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: Geofence, factory: function (t) { return Geofence.ɵfac(t); } });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(Geofence, [{
        type: Injectable
    }], null, null); })();
    return Geofence;
}(IonicNativePlugin));
